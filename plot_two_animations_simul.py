# https://stackoverflow.com/questions/19561727/what-is-the-difference-between-the
# -widgets-of-tkinter-and-tkinter-ttk-in-python
...
# import ttk # use tk instead of ttk
...
class GraphPageB(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        # canvasB.show() # no longer used in new tkinter
...
aniA = animation.FuncAnimation(a, updateGraphsA, interval=100, blit=False)
